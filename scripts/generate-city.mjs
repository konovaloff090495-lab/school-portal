...
- features: 5 коротких тегов-характеристик (макс 2-3 слова каждый)
...
function getTypeHint(type) {
  const hints = {
    gosudarstvennye: 'ГБОУ/МАОУ/МОУ, бесплатные, разные профили (математический, языковой, естественнонаучный)',
    chastnie: 'частные школы, платные, малые классы, инновационные методики',
    online: 'дистанционные, онлайн-платформы, гибкий график, аттестация',
    vechernie: 'вечерние/сменные, для работающих, взрослые, гибкий график',
    eksternal: 'экстернат, ускоренное обучение, спортсмены, семейное образование',
    semejnye: 'семейные школы, малые группы, альтернативная педагогика',
    domashnie: 'надомное обучение, дети с ОВЗ, болеющие, спортсмены',
    'pri-vuzakh': 'лицеи и классы при университетах города, целевой набор в вуз',
    profilnye: 'профильные классы — IT, медицина, спорт, гуманитарный, экономика',
    gimnazii: 'гимназии с углублёнными программами, несколько иностранных языков',
