...
const typeDescriptions: Record<SchoolType, string> = {
  ...
  litsei:           'Лицеи России по городам: государственные, при вузах и частные — адреса, телефоны, профили (физико-математический, IT, химико-биологический, гуманитарный), как поступить в 5, 7 и 10 класс. Чем лицей отличается от гимназии и обычной школы.',
  muzykalnye:       'Музыкальные школы России по городам — детские музыкальные школы (ДМШ) и частные школы музыки: адреса, телефоны, оценки на Яндекс Картах (09.2026). Как поступить в ДМШ, с какого возраста берут, что такое предпрофессиональная программа.',
  hudozhestvennye:  'Художественные школы России по городам — детские художественные школы (ДХШ) и частные студии рисования: адреса, телефоны, оценки на Яндекс Картах (09.2026). Приём в ДХШ с 10–11 лет, вступительный просмотр, бюджетные и платные места.',
  iskusstv:         'Детские школы искусств (ДШИ) России по городам: музыкальное, художественное, хореографическое и театральное отделения — адреса, телефоны, оценки на Яндекс Картах (09.2026). Как поступить, сроки обучения 4–8 лет, бюджетные места.',
}
...
const typeTitleOverrides: Partial<Record<SchoolType, (n: number) => string>> = {
  ...
  litsei: n => `Лицеи России 2026: ${n} ${n % 10 === 1 && n % 100 !== 11 ? 'лицей' : n % 10 >= 2 && n % 10 <= 4 && (n % 100 < 10 || n % 100 >= 20) ? 'лицея' : 'лицеев'} по городам — адреса, профили, как поступить`,
  muzykalnye:       n => `Музыкальные школы России 2026: ${n} ${schoolWord(n)} по городам — ДМШ и частные, адреса, как поступить`,
  hudozhestvennye:  n => `Художественные школы России 2026: ${n} ${schoolWord(n)} по городам — ДХШ и студии, адреса, приём`,
  iskusstv:         n => `Школы искусств России 2026: ${n} ${schoolWord(n)} по городам — ДШИ, отделения, адреса, как поступить`,
}
function schoolWord(n: number) { const m10 = n % 10, m100 = n % 100; return m10 === 1 && m100 !== 11 ? 'школа' : m10 >= 2 && m10 <= 4 && (m100 < 10 || m100 >= 20) ? 'школы' : 'школ' }
...
export default async function GlobalTypePage({ params }: Props) {
  ...
  const seoContent = t === 'profilnye'
    ...
    ? <>
        <EksternalSubNav />
        <OnlineLeadCta
          source="Экстернат: хаб /shkoly/tipy/eksternal/"
          heading="Экстернат онлайн: 10–11 класс за один год"
          text="Онлайн-школа с государственной лицензией и аккредитацией зачисляет на экстернат дистанционно: два класса за год, аттестации онлайн, ЕГЭ — в вашем городе, аттестат государственного образца. Оставьте контакты — перезвоним за 30 минут и расскажем условия."
          bullets={['документы сканами, зачисление круглый год', 'для подростков и взрослых с перерывом в учёбе', 'рассрочка, маткапитал, налоговый вычет']}
        />
        <TypeGuide type={t} />
      </>
    : t === 'online'
  ...
  return (
    <CatalogClient
      ...
      subtitle={(t === 'podgotovka-ege' || t === 'podgotovka-oge') ? `${count} ${centersWord(count)} подготовки в 30 крупных городах — выберите город в фильтре` : t === 'programmirovanie' ? `${count} школ и клубов в 40 городах по данным Яндекс Карт — выберите город в фильтре` : t === 'litsei' ? `${count} лицеев — государственных, при вузах и частных — выберите город в фильтре` : `${count} школ — выберите город в фильтре`}
      breadcrumbs={[
