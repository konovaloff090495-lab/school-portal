      ...
      <main className="gdz-main">
        ...
        <aside className="gdz-ad gdz-ad-inline" data-rsya="R-A-19425636-1" aria-label="Реклама">
          ...
          <div className="gdz-ad-slot">
            <YandexRTBBanner blockId={AD_BLOCKS.gdzUchebnik} suffix="index-inline" viewport="mobile" />
          </div>
        </aside>
        ...
        <aside className="gdz-ad gdz-ad-inline" aria-label="Реклама">
          <div className="gdz-ad-label"><span>Реклама</span><span className="age">16+</span></div>
          <div className="gdz-ad-slot">
            <YandexRTBBanner blockId={AD_SLOT_3} suffix="index-pop" />
          </div>
        </aside>
        ...
        {/* Слот 2 — под предметами, все экраны */}
        <aside className="gdz-ad gdz-ad-inline" aria-label="Реклама">
          <div className="gdz-ad-label"><span>Реклама</span><span className="age">16+</span></div>
          <div className="gdz-ad-slot">
            <YandexRTBBanner blockId={AD_SLOT_2} suffix="index-mid" />
          </div>
        </aside>
      </main>
        ...
        <div className="gdz-rail-sticky">
          <div className="gdz-ad" data-rsya="R-A-19425636-1">
            ...
            <div className="gdz-ad-slot gdz-ad-slot--tall">
              <YandexRTBBanner blockId={AD_BLOCKS.gdzUchebnik} suffix="index-sidebar" viewport="desktop" />
            </div>
          </div>
        </div>
      </aside>
