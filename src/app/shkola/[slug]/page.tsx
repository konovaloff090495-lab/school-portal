      ...
      <div className="mt-6 grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6">
            ...
            {/* OpenStreetMap — бесплатно, без ключей, без блокировок */}
            <div className="mb-5 rounded-xl overflow-hidden border border-gray-100" style={{ height: 280 }}>
              {school.lat && school.lon ? (
                <iframe
                  ...
                  src={`https://www.openstreetmap.org/export/embed.html?bbox=${school.lon - 0.012},${school.lat - 0.007},${school.lon + 0.012},${school.lat + 0.007}&layer=mapnik&marker=${school.lat},${school.lon}`}
                  width="100%"
                  height="280"
                  loading="lazy"
                  className="block"
                ...
                <a
                  href={`https://www.openstreetmap.org/search?query=${encodeURIComponent(`${school.city}, ${school.address}`)}`}
                  target="_blank"
