...
const TYPE_META: {
  ...
  },
  {
    ...
    tint: '#C026D3',
    image: null,
    href: '/shkoly/tipy/muzykalnye/',
    sub: 'ДМШ и частные школы музыки: инструмент, вокал, сольфеджио',
  },
  {
    ...
    tint: '#E11D48',
    image: null,
    href: '/shkoly/tipy/hudozhestvennye/',
    sub: 'ДХШ и студии: рисунок, живопись, композиция',
  },
  {
    slug: 'iskusstv',
    name: 'Школы искусств',
    tint: '#DB2777',
    image: null,
    href: '/shkoly/tipy/iskusstv/',
    sub: 'ДШИ: музыка, рисование, хореография, театр в одном месте',
  },
  {
    slug: 'korrektsionnye',
    name: 'Коррекционные',
