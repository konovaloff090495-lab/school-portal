...
// Дедлайн оффера. История: «последняя волна» до 31.08.2026 → с 21.09.2026 «перевод без потери
// I четверти» до её конца (25.10.2026 — типичная граница четверти при пятидневке; менеджер
// школы-партнёра обещает перевод без потери четверти, см. school-university.com/lib/popups.ts).
// После даты таймер и подписи «до …» прячутся сами (isDeadlinePassed), протухший оффер не висит.
// Новую дату ставить ТОЛЬКО здесь; следующая осмысленная — конец II четверти (~27.12.2026).
const TARGET = new Date('2026-10-25T23:59:59+03:00').getTime()
export const DEADLINE_LABEL = 'до конца I четверти'
